...
func commandWarnUser(s *discordgo.Session, m *discordgo.MessageCreate, args docopt.Opts) error {
	...
	if m.Message.Member.User.ID == user.ID && userID == "550664345302859786" { // Wasan's ID
